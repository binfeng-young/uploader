...
DeviceWidget::DeviceWidget(QWidget *parent) :
    QWidget(parent),myDevice(new Ui::deviceWidget())
{
 ...
 */
bool descriptionToStructure(QByteArray desc, deviceDescriptorStruct & struc) {
...
// Note: the ARM binary is big-endian:
        ...
        struc.
            gitHash = QString("%1").arg(gitCommitHash, 8, 16, QChar('0'));
        ...
        struc.
            gitDate = QDateTime::fromTime_t(gitDate).toUTC().toString("yyyyMMdd HH:mm");
...
// TODO: check platform compatibility
        ...
        struc.
            boardType = (quint8) targetPlatform.at(0);
        struc.
            boardRevision = (quint8) targetPlatform.at(1);
        struc.fwHash.
...
{
    if (descriptionToStructure(desc, onBoardDescription)) {
...
{
    if (descriptionToStructure(desc, LoadedDescription)) {
