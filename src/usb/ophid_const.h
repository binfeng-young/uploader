...
#include <QDebug>
#define OPHID_DEBUG_ON
#ifdef OPHID_DEBUG_ON
#define OPHID_DEBUG(fmt,  ...)   qDebug("[DEBUG] " fmt, ##__VA_ARGS__)
#define OPHID_TRACE(fmt,  ...)   qDebug("[TRACE] %s:%d: " fmt, __func__, __LINE__, ##__VA_ARGS__)
#define OPHID_ERROR(fmt,  ...)   qDebug("[ERROR] %s:%d: " fmt, __func__, __LINE__, ##__VA_ARGS__)
